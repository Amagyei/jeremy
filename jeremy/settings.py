"""
Django settings for jeremy project.
...
SECRET_KEY = "django-insecure-i6q$ws@8tx%dn0p=ztosmvu0_lkn7ib=q)zy8!m^)cq=m6p(l8"
...
WSGI_APPLICATION = "jeremy.wsgi.application"
